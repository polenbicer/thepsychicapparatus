...
export default function Home() {
  ...
  const chooseProjection = (choice: string) => {
    ...
    if (projectionIndex < projectionCards.length - 1) setProjectionIndex((v) => v + 1); else setScreen("politics");
  };
