...
export default function Home() {
  ...
  return <main className="game-shell"><div className="noise"/><section className="phone-frame">
    ...
    <div className="stage">
      ...
      {screen === "confession" && <div className="screen-in"><p className="chapter">08 / UNSUPERVISED CONFESSION</p><h2>What is one thought about Polen you probably should not submit as evidence?</h2><div className="choices"><button onClick={() => chooseConfession("I want to kiss her again")}>I want to kiss her again</button><button onClick={() => chooseConfession("I wonder what she would do if I stopped behaving")}>I wonder what she would do if I stopped behaving</button><button onClick={() => chooseConfession("I have imagined waking up next to her")}>I have imagined waking up next to her</button><button onClick={() => chooseConfession("The thought is too explicit for written evidence")}>The thought is too explicit for written evidence</button></div></div>}
