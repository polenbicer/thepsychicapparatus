...
const desireQuestions = [
  ...
  { prompt: "During the famous billiards night, where did Polen make the first move and kiss you?", options: ["At the billiards table", "In the bathroom", "Outside the bar", "In front of everyone"] },
];
